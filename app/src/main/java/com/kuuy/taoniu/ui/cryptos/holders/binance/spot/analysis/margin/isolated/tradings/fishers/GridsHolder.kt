...
class GridsHolder(
  private val binding: ItemCryptosBinanceSpotAnalysisMarginIsolatedTradingsGridsBinding,
) : BaseListViewHolder<GridInfo, ItemCryptosBinanceSpotAnalysisMarginIsolatedTradingsGridsBinding>(binding) {

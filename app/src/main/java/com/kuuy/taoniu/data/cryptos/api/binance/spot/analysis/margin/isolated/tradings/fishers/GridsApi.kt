package com.kuuy.taoniu.data.cryptos.api.binance.spot.analysis.margin.isolated.tradings.fishers
...
interface GridsApi {
  @GET("v1/binance/spot/analysis/margin/isolated/tradings/fishers/grids")
